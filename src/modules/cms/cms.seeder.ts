...
const heroSlidesData = [
    ...
    },
    {
        ...
        fallbackGradient: 'bg-gradient-to-br from-purple-600 via-pink-600 to-purple-800',
        ctaText: 'GET STARTED',
        ctaLink: '/register',
        order: 4,
        isActive: true,
...
const serviceCardsData = [
    {
        ...
        image: '/images/services/gymnastics.jpg',
        emoji: '🤸',
    ...
    },
    {
        ...
        image: '/images/services/multi-activity.jpg',
        emoji: '⚡',
        features: ['Multiple sports exposure', 'Motor skills development', 'Team building activities', 'Confidence building', 'Fun & engaging'],
        href: '/programs/multi-activity',
        color: 'blue',
